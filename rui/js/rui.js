(function($) {
  ...
  function addRuiTableRowLink() {
    var ruiTableRowWithDetailPage = document.getElementsByClassName('js_rui_detail_link');
    for (var i = 0; i < ruiTableRowWithDetailPage.length; i++) {
      ruiTableRowWithDetailPage[i].addEventListener('click', function(event) {
