...
module.exports = class Color {
  ...
  get whiteness () {
    let white = Math.round(this.white * 100).toString();
    if (white.length === 1) white = `0${white}`;
    return white;
  }
  get blackness () {
    let black = Math.round(this.black * 100).toString();
  ...
  toHex () {
    let r = Math.round(this.red * 255).toString(16);
    let g = Math.round(this.green * 255).toString(16);
    let b = Math.round(this.blue * 255).toString(16);
